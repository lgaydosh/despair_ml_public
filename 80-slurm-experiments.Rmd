...
save_h2o_model <- function(h2o_mdl, is_rf, save_dir, taskid){
  #Function save_h2o_model: saves FINAL h2o models as "save_dir/final_x_model_taskid" where x is the model type 
  #  defined by is_rf
  #is_rf: Boolean; TRUE if the model is a random forest; false if LASSO.
  #save_dir: string reflecting base directory; if you want to save in the current directory, use '.'
  ...
  #get variable name as string
  if(is_rf)
    save_data_str <- 'final_rf_model'
  else
    save_data_str <- 'final_lasso_model'
