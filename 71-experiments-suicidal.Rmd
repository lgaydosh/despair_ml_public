...
pacman::p_load(SASxport, haven, gtools, tidyverse, janitor, naniar, Hmisc, scales, reshape, HH, likert, reshape2,forcats,splitstackshape,rsample, h2o, furrr, rcompanion, plotly)
...
suicide_ds %>% 
  pairwise_cramers_v() %>% 
  plot_cramer_v(value_cutoff = 0.2,
                x_axis_angle = 90,
