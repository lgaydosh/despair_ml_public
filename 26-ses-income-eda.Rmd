...
The purpose of this document is to perform EDA on the SES income/poverty/wealth variables (29 used).
The SES income/poverty/wealth variables are: \ 
'h3ec1c', 'h3ec1d', 'h3ec1e', 'h3ec4 ', 'h3ec5', 'h3ec3', 'h3ec6', 'h3ec7', 'h3ec8', 'h3ec9', 'h3ec10', 'h3ec55',
'h4ec1', 'h4ec3', 'h4ec2', 'h4ec4', 'h4ec8', 'h4ec9',
'h5ec1', 'h5ec2', 'h5ec4', 'h5ec5a', 'h5ec5b', 'h5ec5c', 'h5ec6', 'h5ec5a', 'h5ec5b', 'h5ec5c', 'h5ec6'
...
sinc_list <- c(
                    'h3ec1c', 'h3ec1d', 'h3ec1e', 'h3ec4', 'h3ec5', 'h3ec3', 'h3ec6', 'h3ec7', 'h3ec8', 'h3ec9', 'h3ec10', 'h3ec55',
'h4ec1', 'h4ec3', 'h4ec2', 'h4ec4', 'h4ec8', 'h4ec9',
'h5ec1', 'h5ec2', 'h5ec4', 'h5ec5a', 'h5ec5b', 'h5ec5c', 'h5ec6')
```
...
final_data_all <- data_combined_all %>%
  dplyr::select(aid, tidyselect::all_of(sinc_list))
```
...
q1_sinc <- hist_by_var(final_data_all, c('h4ec1', 'h5ec2'), 14,"household income")


grid.arrange(q1_sinc, nrow = 1)
 
```


Income distribution appears to shift right over time. Wave 5 has one more category than 4 at the higher end.
...
sinc_and_outcomes <- c(sinc_list, "h5ss0b", "h4pe6", "h4pe7") #depression, anxiety, optimism

final_data_corr <- data_combined_all %>%
  dplyr::select(aid, tidyselect::all_of(sinc_and_outcomes))
