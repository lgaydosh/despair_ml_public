...
```{r explore outcome}
# This function takes a look at the outcome of interest and returns visualization that view the outcome
explore_outcome <- function(df, column, binary = TRUE){
...
=======
        labs(title="Count of Outcome of Interest",
>>>>>>> c3c3bb7f550a114bbd4861b3099b80347bd0f62a
...
=======
        labs(title="Count of Outcome of Interest (Binarized)",
>>>>>>> c3c3bb7f550a114bbd4861b3099b80347bd0f62a
        x = column, y = paste0("Count of ", column))
...
# colnames(x) <- "Species"
# x %>% explore_outcome("Species", binary = F)
