...
The purpose of this document is to perform EDA on the Wave 1 climate variables (8 used).

The health behavior variables are: \ 

'w1cl1_a', 'w1cl2_a', 'w1cl3_a', 'w1cl4_a', 'w1cl5_a', 'w1cl6_a', 'w1cl7_a', 'w1cl8_a'
...
#contextual data
context_file <- str_c("Z:/Gaydosh/ONE - Obesity and Neighborhood Environment Files/w1_ONE/Wave I Climate File/w1climat.xpt")
...
final_data_all <- data_combined_all %>%
  dplyr::select(aid, tidyselect::all_of(w1clim_list))
```
...
# Missing value exploration- none missing
...
Exploring correlation of all variables
...
#WHY ONLY 3 VARS
w1clim_and_outcomes <- c(w1clim_list, "h5ss0b", "h4pe6", "h4pe7") #depression, anxiety, optimism

final_data_corr <- data_combined_all %>%
  dplyr::select(aid, tidyselect::all_of(w1clim_and_outcomes))
