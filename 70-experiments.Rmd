...
```{r h2o initialization, eval=FALSE}
#initialize h2o
```
...
```{r feature selection rf, eval=FALSE}
# Function parameters
...
```{r feature selection lasso, eval=FALSE}
# Function parameters
...
```{r feature selection comparison, eval=FALSE}
...
```{r final model evaluation rf, eval=FALSE}
# Function parameters
...
```{r final model evaluation lasso, eval=FALSE}
# Function parameters
...
```{r final model comparison, eval=FALSE}
# Comparison of performance metrics
...
```{r outcome variable comparison, eval=FALSE}
