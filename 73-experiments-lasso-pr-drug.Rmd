---
title: "73-experiments-lasso-pr-drug"
output:
  html_notebook:
    code_folding: hide
    theme: lumen
...
dir_create('p_drug_results_directory')
save(list=save_var_list, file=str_c('p_drug_results_directory', '/', 'experimental_lasso_results_2bs.RData'))
