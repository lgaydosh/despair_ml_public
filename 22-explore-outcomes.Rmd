...
#par(mfrow = c(2,2))
suicidal_outcome_on_question <- function(x, ...){
...
par(mfrow = c(2,2))
barplot(suicidal_outcome_on_question(suicidal_id_outcome, "h1su1")$n, names.arg = c("0","1","6","8","9"), main = "h1su1")
barplot(suicidal_outcome_on_question(suicidal_id_outcome, "h3to130")$n, names.arg = c("0","1","8","7","6","9","missed"), main = "h3to130")
barplot(suicidal_outcome_on_question(suicidal_id_outcome, "h4se1")$n, names.arg = c("0","1","6","7","8","missed"), main = "h4se1")
barplot(suicidal_outcome_on_question(suicidal_id_outcome, "h5mn8")$n, names.arg = c("0","1","missed"), main = "h5mn8")
