...
add_demographics <- function(df){
  ...
  df %>% 
    dplyr::mutate(
      ...
      age_w1 = floor_dec((((as.double(str_c("19",iyear))*12 )+imonth) - birth_in_months)/12, 2), 
      age_w3 = floor_dec((((iyear3*12)+imonth3)-birth_in_months)/12, 2),
      age_w4 = floor_dec((((iyear4*12)+imonth4)-birth_in_months)/12, 2),
      age_w5 = floor_dec((((iyear5*12)+imonth5)-birth_in_months)/12, 2)) %>% 
