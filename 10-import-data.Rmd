...
suicidal_ideation_list <- c("aid","h1su1","h3to130","h4se1","h5mn8")

# List of variables to indicate marijuana usage in the last 30 days
marijuana_use30_list <- c("aid", "h1to32","h3to110","h4to71","h5to21") #During the past 30 days, on how many days did you use marijuana?
...
suicidal_id <- joined_waves[suicidal_ideation_list]

#Subset of data with all marijuana usage in last 30 days variables                            
marijuana_usage30 <- joined_waves[marijuana_use30_list]
```
