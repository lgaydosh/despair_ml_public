...
add_wave4_lipids <- function(df, filepath = "~/gvfs/smb-share:server=vu1file.it.vanderbilt.edu,share=gaydosh_addhealth/Gaydosh/Wave IV Biomarker Files/Wave IV Lipids/lipids.xpt" ){
  require(janitor)
...
add_wave_4_bio_despair <- function(df, 
  ...
  df <- df %>% 
    ...
    add_wave4_lipids(filepath_lipids)
