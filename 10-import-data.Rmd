...
Instructions:
Run below chunk and select all the 5 wave files you wish you import.
...
anxiety <- predictor_vars %>%
  dplyr::select(aid,h4pe6,h4pe14,h4pe22,h4pe30)

```


# Diagnosed Anxiety Variables
```{r}
diag_anxiety <- predictor_vars %>%
...
h3sp5,h4mh18,h3sp6,h4mh19,h5ss0a,h3sp7,h4mh20,h3sp8,h4mh21,h3sp9,h4mh22,h5ss0b,h3sp10,h4mh23,h4mh24,h5ss0c,h3sp11,h4mh25,h3sp12,h4mh26,h5ss0d,h3sp13,h4mh27)
...
```{r}
diag_depression <- predictor_vars %>%
...
suicide <- joined_waves %>% 
  dplyr::select(aid,h1su1,h3to130,h4se1,h5mn8)
...
marijuana <- joined_waves %>% 
  dplyr::select(aid,h1to32,h3to110,h4to71,h5to21)
```
