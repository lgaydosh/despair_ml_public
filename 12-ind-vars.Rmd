...
add_parent_health <- function(df){
  ...
  df %>% 
    mutate(p_health = case_when(
      (PC21_1 == 1)&(PC21_2 == 0)&(PC21_3 == 0)&(PC21_4 == 0)&(PC21_5 == 0)&(PC21_6 == 0)&(PC21_7 == 0) ~ 1,
      (PC21_1 == 0)&(PC21_2 == 1)&(PC21_3 == 0)&(PC21_4 == 0)&(PC21_5 == 0)&(PC21_6 == 0)&(PC21_7 == 0) ~ 2,
      (PC21_1 == 0)&(PC21_2 == 0)&(PC21_3 == 1)&(PC21_4 == 0)&(PC21_5 == 0)&(PC21_6 == 0)&(PC21_7 == 0) ~ 3,
      (PC21_1 == 0)&(PC21_2 == 0)&(PC21_3 == 0)&(PC21_4 == 1)&(PC21_5 == 0)&(PC21_6 == 0)&(PC21_7 == 0) ~ 4,
      (PC21_1 == 0)&(PC21_2 == 0)&(PC21_3 == 0)&(PC21_4 == 0)&(PC21_5 == 1)&(PC21_6 == 0)&(PC21_7 == 0) ~ 5,
      (PC21_1 == 0)&(PC21_2 == 0)&(PC21_3 == 0)&(PC21_4 == 0)&(PC21_5 == 0)&(PC21_6 == 1)&(PC21_7 == 0) ~ 6,
      (PC21_1 == 0)&(PC21_2 == 0)&(PC21_3 == 0)&(PC21_4 == 0)&(PC21_5 == 0)&(PC21_6 == 0)&(PC21_7 == 1) ~ 7,
      (PC21_1 == 0)&(PC21_2 == 0)&(PC21_3 == 0)&(PC21_4 == 0)&(PC21_5 == 0)&(PC21_6 == 0)&(PC21_7 == 0) ~ 0)
    )
}
...
w1_ind_vars <- c(w1_health, w1_social, w1_peer, w1_religion, w1_family, w1_future, w1_criminal, w1_ses)
```
...
add_w3_family<- function(df) {
  #need help setting up variables for:
  #closeness to maternal figure "h3wp20", "h3wp32", "h3wp46", "h3wp64"
  #closeness to paternal figure "h3wp25", "h3wp39", "h3wp53"
  #mother monetary support "h3wp21", "h3wp22", "h3wp33" and "h3wp34", "h3wp47", "h3wp48"
  #father monetary support "h3wp26", "h3wp27", "h3wp40" and "h3wp41", "h3wp54", "h3wp55"
  #mother warm and loving "h3wp19", "h3wp31", "h3wp45", "h3wp63"
  #father warm and loving "h3wp24", "h3wp38", "h3wp52"
  #sibling closeness "h3ws5a", "h3ws5b", "h3ws5c", "h3ws5d"
  #sibling problem solving support "h3ws6a", "h3ws6b", "h3ws6c", "h3ws6d"
  
  df<- df %>% 
    mutate(close_monther = case_when())
}
...
add_w3_employ<- function(df){
  #Need to truncate values in h3lm25
  #Keep first 2 digits and drop anything behind the -
}
...
w3_ind_vars <- c(w3_health, w3_social, w3_prosocial, w3_peer, w3_religion, w3_family, w3_structure, w3_partner, w3_child, w3_future, w3_criminal, w3_ses)
```
...
w4_criminal <- c("h4ds7", "h4ds19", "h4ds14", "h4ds20", "h4ds6", "h4ds5", "h4ds4", "h4cj17")
...
add_w4_employ<- function(df){
  #Need to truncate values for h4lm18
  #Keep first 2 digits and drop anything behind the -
}
...
w4_ind_vars <- c(w4_health, w4_social, w4_prosocial, w4_peer, w4_religion, w4_family, w4_structure, w4_partner, w4_child, w4_criminal, w4_stress, w4_ses)
```
...
w5_criminal <- c("h5cj1d", "h5cj1e", "h5cj2b", "h5cj1f", "h5cj1b", "h5cj1c", "h5cj1a")
...
w5_ind_vars <- c(w5_health, w5_social, w5_prosocial, w5_peer, w5_religion, w5_family, w5_structure, w5_partner, w5_child, w5_criminal, w5_stress, w5_ses)
```
