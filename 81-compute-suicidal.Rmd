...
write("Raw data loaded", log_file)
```
...
write(paste("Variables: ", colnames(suicide_ds_)), log_file)
```
...
write("Outcome binarized, NAs removed", log_file)
```
...
write("RF model set up", log_file)
```
...
write("Permutation importance calculated", log_file)
```
...
write("LASSO model set up", log_file)
```
...
write("Coefficient-based variable importance calculated", log_file)
```
...
write("Training set folds added", log_file)
```
...
write("Final RF model completed", log_file)
```
...
write("RF permutation importance completed", log_file)
```
...
write("Final LASSO model completed", log_file)
```
...
write("LASSO permutation importance completed", log_file)
```
