...
Here is a function that we can use to add all constructed outcome variables.  Create your outcome variables in the same manner as `add_pres_drug` and `add_ill_drug` above, and add the function below so that it can be constructed and added to the full modeling dataframe.
