...
```{r}
full_dataset %>% explore_outcome('p_drug')
```
...
mean_bs_rf_perf
```
As shown, the bootstrapped models tend to have high specificity but low sensitivity, indicating that there is a challenge in identifying subjects with prescription drug abuse.
