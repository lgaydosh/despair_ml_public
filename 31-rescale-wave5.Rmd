...
if (!is.null(employ.data$salary[1]) & employ.data$salary[1]== 1){
      employ.data$salary[1]= 0
    }
...
change_scale <- function(df, col_name){
  ...
  for (i in 1:nrow(df)){
    if (!is.null(df$col_name[i]) & length(df$col_name[i]) > 0& df$col_name[i]== 1){
      df$col_name[i]= 0
      print("hi")
    }
    else if (!is.null(df$col_name[i]) & length(df$col_name[i]) > 0& df$col_name[i]== 2){
      df$col_name[i]= 1
    }
    else if (!is.null(df$col_name[i]) & length(df$col_name[i]) > 0& df$col_name[i]== 3){
      df$col_name[i]= 2
    }
    else if(!is.null(df$col_name[i]) & length(df$col_name[i]) > 0& df$col_name[i]== 4){
      df$col_name[i]= 3
    }
    print(i)
    print(df$col_name[i])
