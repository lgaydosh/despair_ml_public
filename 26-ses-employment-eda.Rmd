...
The purpose of this document is to perform EDA on the SES employment variables (17 used).
The SES employment variables are: \ 
'h3lm25', 'h3lm26a', 'h3lm26b', 'h3lm26c', 'h3lm27',
'h4lm18', 'h4lm23', 'h4lm14 ', 'h4lm20', 'h4lm27',
'h5lm9', 'h5lm10 ', 'h5lm11', 'h5lm12', 'h5lm15', 'h5lm5', 'h5lm27'
...
final_data_all <- data_combined_all %>%
  dplyr::select(aid, tidyselect::all_of(sem_list))
```
...
sem_num_list <- c(
               'h3lm27',
               'h4lm23', 'h4lm14', 'h4lm20', 'h4lm27',
              'h5lm15', 'h5lm5', 'h5lm27') 

cor_dat_input <- final_data_all %>%
  dplyr::select(all_of(sem_num_list)) %>%
...
q1_sem <- hist_by_var(final_data_all, c('h4lm23', 'h5lm15'),5, "work autonomy")
q2_sem <- hist_by_var(final_data_all, c('h3lm27', 'h4lm20'), 8,"work schedule") 


grid.arrange(q1_sem, q2_sem, nrow = 1)

 
```


Here is the visualization of how answers change for the same question over different waves. Work autonomy increased from wave 4 to 5. Regular day shifts increased from wave 3 to 4.
