...
n = 5 # number of bootstraps

suicide_out <- training_df %>% 
  model_feature_selection("RF",outcome = suicide_w5, n = 5)
```
...
suicide_out_lasso <- training_df %>% 
  model_feature_selection("Lasso",outcome = suicide_w5, n = 5)
```



```{r explore variable importance for suicide, fig.height=7, fig.width=13}
# This will give you a data frame of top predictors
