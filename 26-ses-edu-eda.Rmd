...
The purpose of this document is to perform EDA on the  variables (16 used). \

The health behavior variables are: \ 
'h1gi20', 'h1ee1', 'h1ee2',
'h3ed1', 'h3ed27', 'h3ed19', 'h3ed20', 'h3ed29', 'h3ed30', 'h3ed16', 'h3ed17',
'h4ed2', 'h4ed8', 'h4ed9',
'h5od11', 'h5od10'
...
final_data_all <- data_combined_all %>%
  dplyr::select(aid, tidyselect::all_of(sed_list))
```
...
cor_dat_input <- final_data_all %>%
  dplyr::select(all_of(sed_missing_num)) %>%
...
# Explore change over time- none are meaningful to compare
...
sed_num_and_outcomes <- c('h1gi20', 'h1ee1', 'h1ee2',
                          'h3ed1', 'h3ed27', 
                          'h4ed2', 'h4ed8', 'h4ed9','h5od11', 'h5od10', 
                          "h5ss0b", "h4pe6", "h4pe7") #depression, anxiety, optimism

final_data_corr <- data_combined_all %>%
  dplyr::select(aid, tidyselect::all_of(sed_num_and_outcomes))
