...
This is the table with all the counts for different levels of the variables. We can see 97 is a legitimate skip variable. We can send this into the recode_variables function and it will be coded as 0 (not responding to questions involving problematic drinking).
